...
export const method = {
    ...
    modes: [
      {
        name: "Observe",
        hint: "watch a system",
        body: "Watch one behaviour or system closely until you can describe how it actually works, not how it is advertised.",
        insightTitle: "It's not just about looking.",
        insight: "It's about really seeing — the details, the people, and the bigger picture.",
        quote: "The world doesn't reveal itself all at once — you have to look closely.",
        caption: "Look closer than you think",
        image: "/assets/korean-food.jpg",
      },
      {
        name: "Interview",
        hint: "ask a stranger",
        body: "Ask one honest question of one real person, and record the real answer rather than the expected one.",
        insightTitle: "It's not just about asking.",
        insight: "It's about hearing an answer you did not expect, from someone you have just met.",
        quote: "One honest question can open a city.",
        caption: "Ask, then listen",
        image: "/assets/students-exchange.jpg",
      },
      {
        name: "Photograph",
        hint: "frame meaning",
        body: "Frame a detail that carries a value. A photograph made to argue something, not to be posted.",
        insightTitle: "It's not just about taking a picture.",
        insight: "It's about framing a value — a detail that argues something, not a postcard.",
        quote: "A photograph made to argue something, not to be posted.",
        caption: "Frame what it means",
        image: "/assets/myeongdong.jpg",
      },
      {
        name: "Sketch",
        hint: "look slowly",
        body: "Draw it. Slow, deliberate looking is the only way to notice what a camera skips.",
        insightTitle: "It's not just about drawing.",
        insight: "Slow looking is the only way to notice what a camera skips.",
        quote: "You cannot sketch what you have not really seen.",
        caption: "Look slowly",
      ...
      },
      {
        name: "Note",
        hint: "what it means",
        body: "Write what you saw, then what it means at home. The second half is where the learning lives.",
        insightTitle: "It's not just about writing it down.",
        insight: "The second half — what it means at home — is where the learning lives.",
        quote: "The learning lives in the translation home.",
        caption: "Write what it means",
        image: "/assets/korea-school-meeting.jpg",
      },
    ],
  },
  lenses: {
  ...
  contrast: {
    a: {
      label: "A sightseeing tour",
      title: "You see the surface.",
      image: "/assets/seoul-skyline.jpg",
      points: ["You are shown a place", "You take a photo", "You move on", "You remember a view"],
    },
    b: {
      label: "A RealWorld Experiential Lab",
      title: "You go deeper.",
      note: "Real people.\nReal systems.\nReal change.",
      points: ["You are given a question", "You read the system", "You interview a stranger", "You leave changed"],
    },
  },
  labStructure: {
...
export const leader = {
  ...
  pathLede: "From a young dreamer to a nation builder — a journey of service, resilience and purpose.",
  bio: [
  ...
  timeline: [
    { when: "1986", tag: "The beginning", what: "Pune to Kanyakumari", body: "The first long journey, taken as a young person. The habit of learning by travelling starts here.", tone: "gold", icon: "sun-hills" },
    { when: "1987", tag: "Border & discipline", what: "Pune to Kathmandu", body: "Further, harder, and across a border.", tone: "mint", icon: "road" },
    { when: "1988", tag: "The method", what: "Pune to Kashmir", body: "The third expedition, and the beginning of a lifelong method.", tone: "sky", icon: "peaks" },
    { when: "Medicine", tag: "Service", what: "Four hospitals, and their design", body: "Practising alongside eminent doctors, and helping plan and design the hospitals themselves.", tone: "lilac", icon: "hospital" },
    { when: "2002 & 2014", tag: "Field work", what: "Afghanistan, with USAID", body: "Field work in emergency and disaster management, and in areas affected by terrorism.", tone: "jade", icon: "camp" },
    { when: "Himalaya", tag: "Teaching", what: "Mountaineering", body: "Time spent with legends of the range, and the discipline a mountain teaches.", tone: "coral", icon: "flag-peak" },
    { when: "Since 2000", tag: "Education", what: "RealLives", body: "Building a life simulation drawing on data from 193 countries, now used by schools and universities across North America, Europe and Asia.", tone: "ice", icon: "book" },
    { when: "With Prof. Heckman", tag: "Research", what: "The ChangeMaker Index", body: "A suggestion from the Nobel Laureate seeded a way to measure character through behaviour rather than self report.", tone: "wheat", icon: "podium" },
    { when: "Three times", tag: "India", what: "Prime Ministers of India", body: "One to one meetings, including presenting the RealLives concept to Hon'ble PM Shri Narendra Modi.", tone: "sage", icon: "capitol" },
  ],
  photos: [
